...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "FinanceTracker.App.dll" comes first in this list. */
		"FinanceTracker.App.dll",
		"BemIt.dll",
		"DeepCloner.Core.dll",
		...
		"GoogleGson.dll",
		"Masa.Blazor.dll",
		"Masa.Blazor.MobileComponents.dll",
		...
		"FinanceTracker.Infrastructure.dll",
		"FinanceTracker.Shared.dll",
		"FinanceTracker.Web.dll",
